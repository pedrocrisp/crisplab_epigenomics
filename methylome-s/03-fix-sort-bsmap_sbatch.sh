...
usage="USAGE:
bash 03-fix-sort-bsmap_sbatch.sh <sample_list.txt> <walltime> <memory> <account_department>
for example:
bash \
/home/uqpcrisp/gitrepos/crisplab_epigenomics/methylome/03-fix-sort-bsmap_sbatch.sh \
single_sample.txt
48:00:00
40
"
