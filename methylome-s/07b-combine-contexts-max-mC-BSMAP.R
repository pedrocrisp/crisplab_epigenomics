...
cg <- read_tsv(paste0("tiles/", sample_name, "_BSMAP_out.txt.100.CG.fixed.sorted.txt"))
chg <- read_tsv(paste0("tiles/", sample_name, "_BSMAP_out.txt.100.CHG.fixed.sorted.txt"))
chh <- read_tsv(paste0("tiles/", sample_name, "_BSMAP_out.txt.100.CHH.fixed.sorted.txt"))
