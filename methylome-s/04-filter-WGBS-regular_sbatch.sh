...
usage="USAGE:
bash 04-filter_sbatch.sh <sample_list.txt> <paired_end> <walltime> <memory> <account_department>
for example:
bash \
/home/springer/pcrisp/gitrepos/springerlab_methylation/SeqCap/04-filter-WGBS-regular_sbatch.sh \
single_sample.txt \
yes \
24:00:00 \
40 \
