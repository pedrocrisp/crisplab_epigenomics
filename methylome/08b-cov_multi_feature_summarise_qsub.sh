...
usage="USAGE:
bash 08b-cov_feature_summarise_qsub.sh <sample_list.txt> <walltime> <memory> <out folder>
"

#define stepo in the pipeline - should be the same name as the script
step=08b-cov_multi_feature_summarise
...
-v LIST=${sample_list},out_dir=${out_dir} \
$script_to_qsub
