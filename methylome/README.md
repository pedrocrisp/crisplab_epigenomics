...
This is a multi purpose plant methylome pipeline that is used for processing SeqCap data, WGBS data, EM-seq data and also for identifying Unmethylated Regions (UMRs).
