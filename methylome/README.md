...
This is a multi purpose methylome pipeline that is used for processing SeqCap data, WGBS data, EM-seq data and also for identifying Unmethylated regions (UMRs).
