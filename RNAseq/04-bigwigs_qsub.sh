...
usage="USAGE:
bash 04-bigwigs_qsub.sh <sample_list.txt> <walltime> <memory> <account_department> <alignFolder> <strand> <chrc_sizes>"
...
-v LIST=${sample_list},strand=$strand,chrc_sizes=$chrc_sizes,alignFolder=$alignFolder \
