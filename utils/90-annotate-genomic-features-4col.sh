...
### Inputs
# The input bed file should be 4 columns
# 4 column version
# Column1: chromosome
# Column2: start
# Column3: stop
...
R -f ~/gitrepos/crisplab_epigenomics/utils/90-annotate-genomic-features-4col.R \
--args $sample_name $outputFile $reference_annotation_mame $summary_output_folder

# to run
# bash ~/gitrepos/crisplab_epigenomics/utils/90-annotate-genomic-features.sh \
# <>.bed \
# >> \
