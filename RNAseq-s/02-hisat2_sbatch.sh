...
usage="USAGE:
bash 02-hisat2_sbatch.sh <account_department> <sample_list.txt> <walltime> <memory> <threads> <aligner> <genome_index> <strandedness>"
...
--export LIST=${sample_list},index=$index,aligner=$aligner,threads=$threads,strandedness=$strandedness \
